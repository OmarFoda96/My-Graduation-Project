    ...
    <nav class="navbar navbar-inverse" role="navigation">
      ...
      <div id="main-nav" class="collapse navbar-collapse">
        <ul class="nav navbar-nav" id="mainNav">
          ...
          <li  class="active" ><a href="bookingar.php" class="scroll-link">الحجز</a></li>
          <li ><a href="electronicArchivear.php" class="scroll-link">السجل الطبى</a></li>
          <li><a href="bloodBankar.php" class="scroll-link">بنك الدم</a></li>
        </ul>
      </div>
      <!--/.navbar-collapse--> 
    </nav>
...
<!--/.header-->
    <div class="container">
        <div class="bookingForm">
            <div class="row">
                <h1 class="klmtBook" style="margin-left: 70px;">اهلا بك فى قائمة حجز المواعيد</h1>
            </div>
            ...
            <div class="row">
                <form class="selectBooking" method="post">
                   <?php
                    ...
                    <select  class="col-md-3 col-xs-8" id="hospitalBook" name="hospital">
                      <option value="">من فضلك اختار المشفى :</option>
                      <?php 
                    ...
                    <select id="doctorSelect" name="doctor" class="col-md-3 col-xs-8">
                      <option value="">من فضلك اختر الطبيب</option>
                      
                    </select>
                    <br><br><br>
                    <div class="row" style="margin-left: 5px;">
                    <select id="doctorDates" class="col-md-9 col-xs-9" name="date">
                      <option value="">من فضلك اختر الميعاد :
                      </option>
              ...
              <select  id="useridval" style="display: none;" value="">
                 <option value="<?php echo $_SESSION['userdata']['UserId']  ?>">
                    ...
                    <button style="margin-left: 35%; margin-top: 48%; width: 350px; height: 41px; font-size: 25px; padding: 2px;" class="btn secondary-btn" id="boookBtn">احجز الان</button>
              <div id="wait"></div>
            </div>
        </div>
        ...
        <a href="bookingar.php" style="text-decoration: none;">AR |</a> <a href="booking.php" class="active" style="text-decoration: none;">| EN</a>
     ...
     $.ajax({
        ...
        method: 'GET',
         ...
         success: function(data){
            ...
            document.cookie = (document.getElementById('hospitalBook').value);
        }
        }
      });
  })
...
<script type="text/javascript">
  $('#doctorSelect').on('change', function () {
     $.ajax({
        url: 'http://se7ety3-001-site1.gtempurl.com/api/hospitals/Dates/'+ $("#hospitalBook").val()+"/" + $(this).val(),
        method: 'GET',
