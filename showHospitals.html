    ...
    <nav class="navbar navbar-inverse" role="navigation">
     ...
     <div id="main-nav" class="collapse navbar-collapse">
        <ul class="nav navbar-nav" id="mainNav">
          ...
          <li  ><a href="showBooking.php" class="scroll-link">Booking</a></li>
          <li class="active"><a href="analysis.php" class="scroll-link">Hospitals</a></li>
        </ul>
      </div>
      <!--/.navbar-collapse--> 
    </nav>
  ...
  <!--/.container--> 
        ...
        <div class="container">
          ...
          <div class="panel panel-default">
            <div class="panel-heading" style="font-size: 25px;">This Is All The Hospitals</div>
